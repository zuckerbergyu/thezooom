...
const PaymentSection = ({ sx, data }: Props) => {
  console.log('paymentSection : ', data);
  return (
    <Box sx={styles.root}>
      <Box sx={styles.headerRoot}>
        <Typography sx={styles.headerTxt}>결제 정보</Typography>
      </Box>
        ...
        <Box sx={styles.bodyRoot}>
          <Box sx={styles.bodyPriceRoot}>
            ...
            >
              ...
              <Typography sx={styles.bodyPriceInfoContent}>+0원</Typography>
            </Box>
          </Box>
