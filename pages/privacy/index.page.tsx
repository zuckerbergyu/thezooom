    ...
    <Box sx={styles.root}>
      <Box sx={styles.headerRoot}>
        <Box sx={styles.headerTitleRoot}>
          <Typography sx={styles.headerTitleTxt}>개인정보취급방침</Typography>
        </Box>
        <Box>
          <Typography sx={styles.infoTxt}>
            (주)더줌코리아는 (이하 "회사"는) 고객님의 개인정보를 중요시하며,
      ...
      <Box sx={styles.mgBot20}>
        <Box>
          ...
          <Box sx={styles.mgBot6}>
            <Box>
              <Typography sx={styles.infoTxt}>나. 수집방법</Typography>
            </Box>
            <Box>
              <Typography sx={styles.infoTxt}>
                - 홈페이지, 모바일APP, 서면양식, 게시판, 이메일, 이벤트 응모,
                배송요청, 전화, 팩스, 관계사 및 구매자로부터의 제공, 생성 정보
                수집 툴을 통한 수집
              </Typography>
            </Box>
          </Box>
          <Box sx={styles.mgBot6}>
            <Box>
              <Typography sx={styles.infoTxt}>
                다. 당사는 모바일 앱 서비스를 위하여 아래와 같이 고객의
                이동통신단말기 내 정보 및 기능에 접근, 이용할 수 있습니다.
              </Typography>
            </Box>
            <Box sx={styles.mgBot6}>
              <Typography sx={styles.infoTxt}>
                필수 접근항목은 앱 설치시 또는 최초 실행시 안내 및 동의를
                받으며, 선택 접근항목은 해당 서비스 최초 이용시 별도 동의를
                받습니다.
              </Typography>
              <Typography sx={styles.infoTxt}>
                선택 접근항목의 경우 OS버전에 따라 동의 받는 방법이 다를 수
                있으나, 회원이 거부하더라도 기본 서비스 이용에는 제한이
                없습니다.
              </Typography>
            </Box>
            <Box>
              <Typography sx={styles.infoTxt}>
                - 필수 : 기기 및 앱 기록 권한(앱 실행시 오류확인, 사용성 개선)
              </Typography>
              <Typography sx={styles.infoTxt}>
                - 선택 : 사진/카메라(상품평, 게시판 등)
              </Typography>
              <Typography sx={styles.infoTxt}>
                ※ 선택적 접근권한에 동의하지 않아도 기본적인 서비스 이용은
                가능합니다.
              </Typography>
              <Typography sx={styles.infoTxt}>
                ※ 모바일 기기 및 앱의 설정기능을 통해 접근권한을 설정하실 수
                있으며, 일부 OS버전에 따라 권한설정이 불가능 할 수도 있습니다.
              </Typography>
            </Box>
          </Box>
        </Box>
        ...
        <Box>
          ...
          <Box sx={styles.mgBot6}>
            ...
            <Box sx={styles.mgL8}>
              ...
              <Typography sx={[styles.infoTxt, styles.mgL8]}>
                - 콘텐츠 제공 , 구매 및 요금 결제 , 물품배송 또는 청구지 등 발송
                , 금융거래 본인 인증 및 금융 서비스
              </Typography>
              <Typography sx={styles.infoTxt}>o 회원 관리</Typography>
              <Typography sx={[styles.infoTxt, styles.mgL8]}>
          ...
          <Box sx={styles.mgBot6}>
            ...
            <Box sx={styles.mgL8}>
              ...
              <Box sx={styles.mgL8}>
                ...
                <Typography sx={styles.infoTxt}>-보존기간 : 5년</Typography>
              </Box>
              <Typography sx={styles.infoTxt}>
              ...
              <Box sx={styles.mgL8}>
                ...
                <Typography sx={styles.infoTxt}>-보존기간 : 3년</Typography>
              </Box>
              <Typography sx={styles.infoTxt}>o 로그 기록</Typography>
              <Box sx={styles.mgL8}>
                <Typography sx={styles.infoTxt}>
                  -보존이유: 통신비밀보호법
                </Typography>
                <Typography sx={styles.infoTxt}>-보존기간 : 3개월</Typography>
              </Box>
            </Box>
          </Box>
        </Box>
      ...
      <Box sx={styles.mgBot20}>
        <Box>
          ...
          <Box sx={styles.mgBot6}>
            ...
            <Box sx={styles.mgL8}>
              <Typography sx={styles.infoTxt}>o 파기절차</Typography>
              <Typography sx={[styles.infoTxt, styles.mgL8]}>
              ...
              <Typography sx={styles.infoTxt}>o 파기방법</Typography>
              <Typography sx={[styles.infoTxt, styles.mgL8]}>
      ...
      <Box sx={styles.mgBot20}>
        <Box>
          <Box>
            <Typography sx={styles.subTitleTxt}>■ 개인정보 제공</Typography>
          </Box>
          <Box sx={styles.mgBot6}>
            <Box>
              <Typography sx={styles.infoTxt}>
      ...
      <Box sx={styles.mgBot20}>
        <Box>
          ...
          <Box sx={styles.mgBot6}>
            ...
            <Box sx={styles.mgL8}>
              <Typography sx={styles.infoTxt}>
                o 위탁 대상자 : [CJ대한통운, 한진택배, 우정사업본부, 경동택배]
              </Typography>
              <Typography sx={styles.infoTxt}>
                o 위탁업무 내용 : [상품 배송업무, 배송위치 / 도착정보 등]
              </Typography>
              <Typography sx={styles.infoTxt}>
                o 위탁 대상자 : [KG이니시스, 네이버파이낸셜㈜]
              </Typography>
              <Typography sx={styles.infoTxt}>
                o 위탁업무 내용 : [결제정보 전송, 결제대행 업무]
              </Typography>
            </Box>
          </Box>
        </Box>
      ...
      <Box sx={styles.mgBot20}>
        <Box>
          ...
          <Box sx={styles.mgBot6}>
            ...
            <Box sx={styles.mgL8}>
              <Typography sx={styles.infoTxt}>o 쿠키 등 사용 목적</Typography>
              <Typography sx={[styles.infoTxt, styles.mgL8]}>
              ...
              <Typography sx={styles.infoTxt}>o 쿠키 설정 거부 방법</Typography>
              <Typography sx={[styles.infoTxt, styles.mgL8]}>
      ...
      <Box sx={styles.mgBot20}>
        <Box>
          ...
          <Box sx={styles.mgBot20}>
            <Typography sx={styles.infoTxt}>o 개인정보보호책임자</Typography>
            <Typography sx={[styles.infoTxt, styles.mgL8]}>
              성명 : 송도연
            </Typography>
            <Typography sx={[styles.infoTxt, styles.mgL8]}>
