  ...
  return (
    <Box sx={styles.root}>
      <Box sx={styles.headerRoot}>
        <Box sx={styles.headerTitleRoot}>
          <Typography sx={styles.headerTitleTxt}>이용약관</Typography>
        </Box>
      </Box>
      <Box sx={styles.mgBot20}>
        <Box>
          <Box>
            <Typography sx={styles.subTitleTxt}>제1조(목적)</Typography>
          </Box>
          <Box sx={styles.mgBot6}>
            <Box>
              <Typography sx={styles.infoTxt}>
                이 약관은 (주)더줌코리아(전자상거래 사업자)가 운영하는 휴샵
                몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하
                “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리.의무
      ...
      <Box sx={styles.mgBot20}>
        <Box>
          <Box>
            <Typography sx={styles.subTitleTxt}>제2조(정의)</Typography>
          </Box>
          <Box sx={styles.mgBot6}>
            <Box sx={styles.mgL8}>
              <Typography sx={styles.infoTxt}>
                ① “몰”이란 (주)더줌코리아가 재화 또는 용역(이하 “재화 등”이라
      ...
      <Box sx={styles.mgBot20}>
        <Box>
          <Box>
            <Typography sx={styles.subTitleTxt}>
      ...
      <Box sx={styles.mgBot20}>
        <Box>
          <Box>
            <Typography sx={styles.subTitleTxt}>제6조(회원가입)</Typography>
          </Box>
          <Box sx={styles.mgBot6}>
            <Box sx={styles.mgL8}>
              <Typography sx={styles.infoTxt}>
      ...
      <Box sx={styles.mgBot20}>
        <Box>
          <Box>
            <Typography sx={styles.subTitleTxt}>제9조(구매신청)</Typography>
          </Box>
          <Box sx={styles.mgBot6}>
            <Box sx={styles.mgL8}>
              <Typography sx={styles.infoTxt}>
              ...
              <Box sx={styles.mgL12}>
                ...
                <Typography sx={styles.infoTxt}>6. 결제방법의 선택</Typography>
              </Box>
              <Typography sx={styles.infoTxt}>
        ...
        <Box>
          ...
          <Box sx={styles.mgBot6}>
            <Box sx={styles.mgL8}>
              ...
              <Typography sx={styles.infoTxt}>
                ④ 계약이 성립한 후 "몰"이 제 1항 각 호의 사유를 발견한 경우
                "몰"은 즉시 계약을 취소 할 수 있으며 계약 취소 시 고객이 결제한
                상품 대금은 즉시 환불처리 됩니다.
              </Typography>
            </Box>
          </Box>
      ...
      <Box sx={styles.mgBot20}>
        <Box>
          <Box>
            <Typography sx={styles.subTitleTxt}>제11조(지급방법)</Typography>
          </Box>
          <Box sx={styles.mgBot6}>
            <Box>
              <Typography sx={styles.infoTxt}>
                “몰”에서 구매한 재화 또는 용역에 대한 대금지급방법은 다음 각
                호의 방법중 가용한 방법으로 할 수 있습니다. 단, “몰”은 이용자의
            ...
            <Box sx={styles.mgL8}>
              ...
              <Typography sx={styles.infoTxt}>3. 온라인무통장입금</Typography>
              <Typography sx={styles.infoTxt}>
                4. 전자화폐에 의한 결제
              </Typography>
              <Typography sx={styles.infoTxt}>5. 수령 시 대금지급</Typography>
              <Typography sx={styles.infoTxt}>
        ...
        <Box>
          ...
          <Box sx={styles.mgBot6}>
            <Box sx={styles.mgL8}>
              ...
              <Typography sx={styles.infoTxt}>
                ③ "몰"과 고객간에 상품의 인도시기 및 용역의 제공시기에 관하여
                별도의 약정이 있는 경우에는 당해 약정이 우선합니다.
              </Typography>
            </Box>
          </Box>
        </Box>
      ...
      <Box sx={styles.mgBot20}>
        <Box>
          <Box>
            <Typography sx={styles.subTitleTxt}>제14조(환급)</Typography>
          </Box>
          <Box sx={styles.mgBot6}>
            <Box>
              <Typography sx={styles.infoTxt}>
      ...
      <Box sx={styles.mgBot20}>
        <Box>
          <Box>
            <Typography sx={styles.subTitleTxt}>제15조(청약철회 등)</Typography>
          </Box>
          <Box sx={styles.mgBot6}>
            <Box sx={styles.mgL8}>
              <Typography sx={styles.infoTxt}>
        ...
        <Box>
          ...
          <Box sx={styles.mgBot6}>
            <Box sx={styles.mgL8}>
              ...
              <Typography sx={styles.infoTxt}>
                ②“몰”은 대금을 환급 시 결제금액 전액을 환불해 드립니다. 다만,
                다음 각 사항에 어느 하나에 해당하는 경우 회사는 결제금액에서
                회원이 결제한 상품에 포함된 추가 구성품, 증정품의 가격과
                배송비를 공제한 후에 환불합니다.(패키지 구성품, 추가 구성품의
                가격은 서비스 이용 계약 체결 시 안내된 최종 판매 금액을
                의미합니다. 이하 같습니다.)
              </Typography>
              <Box sx={styles.mgL12}>
                <Typography sx={styles.infoTxt}>
                  1) 회원에게 책임 있는 사유로 멸실 또는 훼손된 경우
                </Typography>
                <Typography sx={styles.infoTxt}>
                  2) 회원이 사용하거나 일부 소비하여 그 가치가 현저히 감소한
                  경우
                </Typography>
                <Typography sx={styles.infoTxt}>
                  3) 시간의 경과에 의하여 재판매가 곤란할 정도로 가치가 현저히
                  감소한 경우
                </Typography>
                <Typography sx={styles.infoTxt}>
                  4) 포장을 훼손한 경우
                ...
                <Typography sx={styles.infoTxt}>
                  5) 회원의 주문에 의하여 개별적으로 생산되어 반품 또는 환불시
                  회사에게 회복할 수 없는 중대한 피해가 예상되는 경우
                </Typography>
              </Box>
              <Typography sx={styles.infoTxt}>
      ...
      <Box sx={styles.mgBot20}>
        <Box>
          <Box>
            <Typography sx={styles.subTitleTxt}>제18조(“몰“의 의무)</Typography>
          </Box>
          <Box sx={styles.mgBot6}>
            <Box sx={styles.mgL8}>
              <Typography sx={styles.infoTxt}>
        ...
        <Box>
          ...
          <Box sx={styles.mgBot6}>
            ...
            <Box sx={styles.mgL8}>
              ...
              <Typography sx={styles.infoTxt}>2. 타인의 정보 도용</Typography>
              <Typography sx={styles.infoTxt}>
                3. “몰”에 게시된 정보의 변경
              </Typography>
              <Typography sx={styles.infoTxt}>
              ...
              <Typography sx={styles.infoTxt}>
                7. “몰”과 계약을 맺었거나 “몰”이 인정한 상품권에 의한 결제7.
      ...
      <Box sx={styles.mgBot20}>
        <Box>
          <Box>
            <Typography sx={styles.subTitleTxt}>제23조(분쟁해결)</Typography>
          </Box>
          <Box sx={styles.mgBot6}>
            <Box sx={styles.mgL8}>
              <Typography sx={styles.infoTxt}>
      ...
      <Box sx={styles.mgBot30}>
        <Box>
          ...
          <Box sx={styles.mgBot6}>
            <Box>
              <Typography sx={styles.infoTxt}>
                "몰"은 이용자에게 적립금 및 쿠폰(이하 “적립금 등”이라 합니다)을
                부여할 수 있고, 적립금 등의 부여 및 사용 등과 관련한 사항은 이
                약관 또는 "몰"의 운영정책이 정한 바에 따릅니다.
              </Typography>
            </Box>
            <Box sx={styles.mgL8}>
              <Typography sx={styles.infoTxt}>
                ① 적립금 등은 "몰" 및 회사가 운영하는 다른 서비스에서 재화 등
                구매 시 현금가액과 동일하게 사용할 수 있으나(단, 적립금 사용이
                불가하다고 사전 고지한 품목은 제외됩니다), 현금으로 교환할 수
                없습니다.
              </Typography>
              <Typography sx={styles.infoTxt}>
                ② 이용자는 적립금 등 부여일로부터 12개월 이내에 그 적립금 등을
                사용하여야 합니다. 단, 적립금 등 부여시 적립금 등 사용기간에
                대해 별도의 사전 고지 또는 특약이 있는 경우에는 그 사용기간
                이내에 사용하여야 합니다. 적립금 등은 부여된 순서로 사용되며,
                부여일로부터 12개월 이후 잔여 적립금이 있는 경우 그 적립금은
                자동적으로 소멸됩니다.
              </Typography>
            </Box>
          </Box>
      ...
      <Typography sx={styles.infoTxt}>
        부 칙(시행일) 이 약관은 2020년 3월 16일부터 시행합니다.
      </Typography>
    </Box>
  );
};
