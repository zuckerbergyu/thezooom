  ...
  return (
    <Box sx={styles.root}>
      ...
      <FoldingSection title="결제 정보">
        <OrderPayment totalPrice={totalPrice} deliveryFee={0} />
      </FoldingSection>
      <Box sx={styles.goShoppingBtnRoot}>
        <ButtonBase
          onClick={() => {
            router.push('/');
          }}
          sx={styles.goShoppingBtn}
        >
          <Typography sx={styles.goShoppingTxt}>계속 쇼핑하기</Typography>
        </ButtonBase>
      </Box>
    </Box>
  );
